      ...
      navigationFormatter : function(index, panel){ // Format navigation labels with text
       ...
       <div id="banner">
	    ...
	    <div class="section_tab">
             ...
             <div id="older_post"><div id="icon_more_news" onclick="sum_news+=5; load_old_posts('http://www.ucreativa.com/ucreasite/app_core/views/sections/news_loadcore.php?s=noticias&param='+sum_news,'news_content_box');">&nbsp;&nbsp;Ver más&nbsp;&nbsp;<span id="loading"></span></div></div>
		</div>
