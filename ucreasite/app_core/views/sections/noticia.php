<?php
    ...
    echo "<script>setOrCreateMetaTag('name','title','".$new_data['title']."');</script>";
    echo "<script>setOrCreateMetaTag('name','description','".$new_data['title']." : ".$new_data['description']."');</script>";

    $metadata = "<meta property='og:title' content='". $new_data['title'] ."' />"
     ."<meta property='og:description' content='".$new_data['description']."' />"
     ."<meta property='og:image' content='' />";
    echo '<script>$("head").append("'.$metadata.'");</script>';
             ...
             <div title="open" class="content_tab">
                 ...
                 <div id="news_blocks">
                     ...
                     <span class="section_text" id="section_text"><div class="published_date"><span>Publicado:&nbsp;<? echo $new_data['created'];?></span></div></span>
                	    <div class="new_block">
                                <?php echo cls_HTML::html_link_tag("[índice]", "", "return", "?s=" . $array_sections[3], "", "índice", "") ?>
                                ...
                                <div id="content_new_1" title="open">
                                        ...
                                        <?php include_once(__VWS_PATH . "/social.php"); //Social Share plugin ?>
                                </div>
                                <?php echo cls_HTML::html_link_tag("[índice]", "", "return", "?s=" . $array_sections[3], "", "índice", "") ?>
                        </div>
	             	</div>
