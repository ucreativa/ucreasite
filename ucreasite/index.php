...
?>
          ...
          <script type="text/javascript">$(document).ready(function() {stLight.options({publisher: "489315f8-4240-4beb-a6ab-0d59a7ed6cbe"}); });</script>
</head>
<body>
            ...
            <?php
             if(isset($_GET['s'])){
               ...
               //Marcamos a nivel GUI la sección actual en la que nos encontramos
                ...
                if($_GET['s']==$array_microsites[2]){
                   include_once(__VWS_PATH . "sections/calendario.php");
                }
                if($_GET['s']==$array_microsites[3]){
                   include_once(__VWS_PATH . "sections/prematricula.php");
                }
                if($_GET['s']=="site_map"){
